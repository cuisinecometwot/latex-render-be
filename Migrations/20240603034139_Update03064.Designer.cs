...
namespace latexapi.Migrations
{
    ...
    [Migration("20240603034139_Update03064")]
    partial class Update03064
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LatexRendererAPI.Models.Domain.ProjectModel", b =>
                {
                    ...
                    b.Property<Guid?>("LastestVersionId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LatexRendererAPI.Models.Domain.ProjectModel", b =>
                {
                    b.HasOne("LatexRendererAPI.Models.Domain.UserModel", "LastModifiedUser")
                        .WithMany()
                        .HasForeignKey("LastestVersionId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("LatexRendererAPI.Models.Domain.UserModel", "Owner")
                        .WithMany()
